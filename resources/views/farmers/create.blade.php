    ...
    <div class="container col-md-6 col-md-offset-3">
        <div class="well well bs-component">
            ...
            <form class="form-horizontal" method="post">
                {!! csrf_field() !!}
                <fieldset>
                    <legend>Create Farmers</legend>

                    <div class="form-group">
                        <label for="farmer" class="col-lg-2 control-label">Farmer</label>
                        <div class="col-lg-10">
                            <input type="text" class="form-control"
                                   id="farmer" placeholder="Farmer" name="farmer">
                        </div>
                    </div>
