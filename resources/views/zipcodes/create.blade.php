        ...
        <div class="well well bs-component">
            ...
            <form class="form-horizontal" method="post">
                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        <label for="state_name" class="col-lg-2 control-label">State Name</label>
                        <div class="col-lg-10">
                            <input type="text" class="form-control" id="state_name" placeholder="Arkansas" name="state_name">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <input type="text" class="form-control" id="country" placeholder="United States" name="country">
                        </div>
                    </div>
