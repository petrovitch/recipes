            ...
            <form class="form-horizontal" method="post">
                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <input type="text" class="form-control" id="abbr"
                                   placeholder="Abbreviation" name="abbr"
                                   value="{{ $commodity->abbr }}">
                        </div>
                    </div>
